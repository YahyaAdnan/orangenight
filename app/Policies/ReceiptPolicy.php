...
class ReceiptPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any Receipt');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Receipt');
    }
    ...
    {
        return $user->checkPermissionTo('replicate Receipt');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Receipt');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Receipt');
    }
}
