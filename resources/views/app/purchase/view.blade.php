...
{{-- 
        ...
        <div class="receipt-details">
            <p><strong>{{ __('customer') }}:</strong> {{ $purchase->customer->full_name }}</p>
            <p><strong>{{ __('sales_man') }}:</strong> {{ $purchase->user->name }}</p>
            <p><strong>{{ $purchase->created_at->format('Y-m-d') }}</strong></p>
            <br>
            <p><strong>{{ __('total_amount') }}:</strong> {{ $purchase->receipt->total_amount }}</p>
            <p><strong>{{ __('discount') }}:</strong> {{ $purchase->receipt->discount_amount }}</p>
            <p><strong>{{ __('selling_price') }}:</strong> {{ $purchase->receipt->amount }}</p>
            <p><strong>{{ __('paid') }}:</strong> {{ $purchase->receipt->paid }}</p>
        </div>
